...
export function EditorPage() {
  ...
  const [type, setType] = useState<"post" | "page">(
    search.get("type") === "page" ? "page" : "post",
  );
  ...
  async function remove() {
    if (!contentId) return;
    if (!confirm("Delete this? Archive first when you can; hard delete is permanent.")) return;
    await api.deleteContent(siteId, contentId);
    nav(`/sites/${siteId}/posts`);
  }
