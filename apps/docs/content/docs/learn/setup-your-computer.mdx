...
description: Node, a package manager, an editor. Once. Then stop thinking about it.
---

Three tools. Install them once. Reuse forever.
...
→ [Your first kumooo.js site](/docs/learn/first-site)
