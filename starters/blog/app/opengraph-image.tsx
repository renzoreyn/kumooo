    ...
    (
      <div
        style={{
          ...
          padding: 72,
          background: "linear-gradient(145deg, #0c0c0e 0%, #1a1218 55%, #0f1412 100%)",
          color: "#f5f5f7",
          fontFamily: "ui-sans-serif, system-ui, sans-serif",
        }}
      >
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <div style={{ width: 44, height: 44, borderRadius: 999, background: "#ff4d6d" }} />
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
          ...
          <div style={{ fontSize: 30, color: "#a1a1a6", maxWidth: 900, lineHeight: 1.35 }}>
            Markdown posts, comments, and Y2K / kumooo / Glass skins. Resets daily.
          </div>
        </div>
        <div style={{ display: "flex", justifyContent: "space-between", fontSize: 24, color: "#8e8e93" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ width: 10, height: 10, borderRadius: 999, background: "#ff4d6d" }} />
            blog.kumooo.site
          </div>
          <div style={{ opacity: 0.7 }}>kumooo.js</div>
        </div>
      </div>
    ),
    { ...size },
